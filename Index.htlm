...
<head>
    ...
    <title>Andualem Guchi - AI Developer</title>
...
<body>
        ...
        <div class="container hero-content">
            <div class="hero-text fade-in">
                ...
                <p style="color: var(--text-secondary); margin-bottom: 28px; max-width: 480px;">
                    AI & Machine Learning enthusiast passionate about building intelligent systems and interactive web experiences.
                </p>
    ...
    <section id="skills">
        <div class="container">
            ...
            <div class="skills-grid">
                ...
                <div class="skill-item fade-in">
                    <div class="skill-name"><span>Neural Networks</span><span>80%</span></div>
                ...
                <div class="skill-item fade-in">
                    <div class="skill-name"><span>JavaScript</span><span>88%</span></div>
                    <div class="skill-bar"><div class="skill-progress" data-width="88"></div></div>
                </div>

                <div class="skill-item fade-in">
                    <div class="skill-name"><span>React / Next.js</span><span>82%</span></div>
                    <div class="skill-bar"><div class="skill-progress" data-width="82"></div></div>
                </div>

                <div class="skill-item fade-in">
                    <div class="skill-name"><span>TensorFlow / PyTorch</span><span>75%</span></div>
        ...
        <div class="container">
            ...
            <div class="timeline">
                ...
                <div class="timeline-item fade-in-left">
                    ...
                    <div class="company">TechCorp AI Labs</div>
                    <div class="date">2022 – Present</div>
                    <p style="color: var(--text-secondary); margin-top: 8px;">
                        Developing neural network models for natural language processing and computer vision applications.
                    </p>
                </div>

                <div class="timeline-item fade-in-right">
                    <h3>Machine Learning Developer</h3>
                    <div class="company">DataScience Hub</div>
                    <div class="date">2020 – 2022</div>
                    <p style="color: var(--text-secondary); margin-top: 8px;">
                        Built and deployed ML models for predictive analytics and recommendation systems using Python and TensorFlow.
                    </p>
                </div>
                ...
                <div class="timeline-item fade-in-left">
                    ...
                    <p style="color: var(--text-secondary); margin-top: 8px;">
                        Developed responsive web applications with integrated AI features and interactive dashboards.
                    </p>
                </div>
        ...
        <div class="container">
            ...
            <div class="projects-grid" id="projects-grid">
                ...
                <div class="project-card" data-category="ai">
                    ...
                    <p>Intelligent chatbot powered by neural networks for natural language understanding.</p>
                ...
                <div class="project-card" data-category="ai">
                    ...
                    <p>Real-time object detection and image recognition using CNN architectures.</p>
                    <div class="tags"><span>PyTorch</span><span>OpenCV</span></div>
                </div>

                <div class="project-card" data-category="web">
                    <div class="icon"><i class="fas fa-code"></i></div>
                    <h3>ML Model Dashboard</h3>
                    <p>Interactive web dashboard for visualizing and monitoring machine learning models.</p>
                    <div class="tags"><span>React</span><span>Flask</span></div>
                </div>

                <div class="project-card" data-category="design">
                    <div class="icon"><i class="fas fa-palette"></i></div>
                    <h3>AI Brand Identity</h3>
                    <p>Complete brand guidelines and design system for an AI startup.</p>
                    <div class="tags"><span>Figma</span><span>Illustrator</span></div>
                </div>
        ...
        <div class="container">
            ...
            <div class="contact-wrapper">
                ...
                <div class="contact-info fade-in-left">
                    ...
                    <p>
                        I'm always open to discussing AI projects, research collaborations, or opportunities in machine learning.
                    </p>
    ...
    <footer>
        <div class="container">
            ...
            <p style="margin-top: 8px; font-size: 0.85rem;">
                <i class="fas fa-envelope"></i> andualemandualem25@gmail.com
            </p>
        </div>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var words = ['AI Developer', 'Machine Learning Engineer', 'Neural Network Architect', 'Deep Learning Enthusiast'];
            var wordIndex = 0;
            var charIndex = 0;
            ...
            // Add a simple fade-in animation for filter
